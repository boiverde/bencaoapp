/*
  # Initial Schema Setup for Bênção Match

  1. Custom Types
    - message_type: For different types of messages (text, verse, prayer)
    - match_status: For tracking match status (pending, accepted, declined, blocked)
  
  2. Tables
    - profiles: User profiles with religious and personal information
  ...
  3. Security
    ...
    - Helper functions for checking conversation participants
*/
