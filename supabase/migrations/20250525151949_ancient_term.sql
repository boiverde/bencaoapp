/*
  # Database Schema Setup for Christian Dating App
  
  1. Custom Types
    - message_type: For different types of messages
    - match_status: For tracking match states
  
  2. Tables
    - profiles: User profiles with religious preferences
  ...
  3. Security
    ...
    - Helper functions for conversation access control
*/
