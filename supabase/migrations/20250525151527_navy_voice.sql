/*
  ...
  1. New Tables
    - profiles
      - User profile information including religious preferences
    - matches
  ...
  2. Types
    - message_type: Type of message (text, verse, prayer)
    - match_status: Status of a match (pending, accepted, declined, blocked)
